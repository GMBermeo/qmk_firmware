 ...
 */
    [_NUMP] = LAYOUT_ortho_4x12_1x2uC(
        RGB_TOG,  KC_NO , KC_NO , KC_NO, KC_NO, KC_NO, KC_NO,  KC_P7,   KC_P8,  KC_P9,  KC_PAST, KC_PSLS,
        KC_NO,  RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_NO, KC_NO,  KC_P4,   KC_P5,  KC_P6,  KC_PMNS,  KC_ENT,
        KC_NO,  RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, KC_NO, KC_PDOT,  KC_P1,   KC_P2,  KC_P3,  KC_PPLS,   KC_NO,
        QK_BOOT, KC_NO, KC_NO, TG(3),    TG(3),   TG(3),     KC_BSPC,  TG(3),   KC_P0, KC_NO, KC_NO
    ),
};
